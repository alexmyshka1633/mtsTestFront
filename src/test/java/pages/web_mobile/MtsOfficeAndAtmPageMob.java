...
public class MtsOfficeAndAtmPageMob {
    ...
    @SneakyThrows
    public MtsOfficeAndAtmPageMob writeCity(String city){
        $(CITY_NAME).click();
    ...
    public MtsOfficeAndAtmPageMob clickFirstCity(){
        $(FIRST_CITY).click();
        return this;
    }

    public MtsOfficeAndAtmPageMob openFiterList(){
        $(BUTTON_FILTER).click();
        return this;
    }

    @SneakyThrows
    public MtsOfficeAndAtmPageMob clickCheckBoxAll(){
        $(CHECKBOX_USD).click();
        $(CHECKBOX_EUR).click();
        $(OPEN_NOW).click();
    ...
    @SneakyThrows
    public MtsOfficeAndAtmPageMob clickOfficeOnMap(){
    ...
    public MtsOfficeAndAtmPageMob getNameOffice(){
        textnameOffice = $(NAME_OFFICE).getText();
        return this;
    }

    public MtsOfficeAndAtmPageMob checkNameOffice(){
        $(BUTTON_LIST).click();
